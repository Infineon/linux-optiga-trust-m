...
## CURL and NGINX example with HSM protected Key-Key OID P12 file
...
```shell
cd scripts/curl_nginx_imported_key/hsm_filename_oid_p12
```
...
```shell
cd scripts/curl_nginx_imported_key/hsm_filename_oid_p12/generate_p12
```
