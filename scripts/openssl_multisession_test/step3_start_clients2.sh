...
openssl s_client -connect localhost:5001 -client_sigalgs ECDSA+SHA256 -keyform engine -engine trustm_engine -cert client1_e0f2.crt -key 0xe0f2:^ -tls1_2 -CAfile $CERT_PATH/OPTIGA_Trust_M_Infineon_Test_CA.pem 
