...
echo "Reset payload version for 0x$TARGET_AES_OID"
...
echo "Write reset_payload_ver_metadata.bin as metadata of 0x$TARGET_AES_OID"
$EXEPATH/trustm_metadata -w 0x$TARGET_AES_OID -F reset_payload_ver_metadata.bin
