...
$EXEPATH/trustm_ecc_sign -k $KEY_OBJ_ID -o ecc_signature.bin -i $DATA_IN -H -X
xxd ecc_signature.bin

$EXEPATH/trustm_data -X -r  0xe0c5

echo "-----> Hash and Verify data with public key: "
$EXEPATH/trustm_ecc_verify -i $DATA_IN -s ecc_signature.bin -p pubkey_$CERT_OBJ_ID.pem -H -X
$EXEPATH/trustm_data -X -r  0xe0c5
done 
